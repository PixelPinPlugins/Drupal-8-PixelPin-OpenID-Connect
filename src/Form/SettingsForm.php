...
class SettingsForm extends ConfigFormBase implements ContainerInjectionInterface {
  ...
  public function buildForm(array $form, FormStateInterface $form_state) {
    ...
    foreach ($properties as $property_name => $property) {
      ...
      if ($property_name == 'field_gender') {
        $default_value = 'gender';
      }
      if ($property_name == 'field_birthdate') {
        $default_value = 'birthdate';
      }
      if ($property_name == 'field_locale') {
        $default_value = 'locale';
      }
      if ($property_name == 'field_phone_number') {
        $default_value = 'phone_number';
      }
      if ($property_name == 'field_street_address') {
        $default_value = 'street_address';
      }
      if ($property_name == 'field_town_city') {
        $default_value = 'town_city';
      }
      if ($property_name == 'field_region') {
        $default_value = 'region';
      }
      if ($property_name == 'field_postal_code') {
        $default_value = 'postal_code';
      }
      if ($property_name == 'field_country') {
